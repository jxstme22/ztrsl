# Virtual cable setup — Windows (VB-CABLE)

A virtual cable is a "software wire": apps play into **CABLE Input**
(render) and you record from **CABLE Output** (capture).

1. Download VB-CABLE (free) from https://vb-audio.com/Cable/ and install.
2. Route the application you want captioned (VALORANT voice chat, Discord,
